...
document.addEventListener("DOMContentLoaded", function () {
    ...
    forms.forEach((form) => {
        ...
        const nameBarbershopInput = form.querySelector("#name-barbershop");
        ...
        function validateInputs() {
            ...
            const isPasswordValid = passwordInput && passwordPattern.test(passwordInput.value);
            ...
            const isNameBarbershopValid = !nameBarbershopInput || nameBarbershopInput.value.trim() !== "";
        ...
        if (nameBarbershopInput) nameBarbershopInput.addEventListener("input", validateInputs);
        ...
        form.addEventListener("submit", function (event) {
            if (!form.canSubmit) {
                ...
                alert("Please ensure all fields are filled out correctly and accept the Terms of Use."); // Show user-friendly message
            }
        });
        ...
        form.submit = function () {
            if (form.canSubmit) {
                ...
                console.error("Programmatic form submission prevented due to validation errors.");
            }
        };
